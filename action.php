...
if(isset($_POST["category"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h4>Product Types</h4></a></li>
	";
			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='bottomheading'>".CURRENCY.". $pro_price.00,-
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-xs'>Add To Cart</button>
								</div>
							</div>
						</div>	
			";
			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='bottomheading'>DKK $pro_price.00,-
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-xs'>Add To Cart</button>
								</div>
							</div>
						</div>	
